...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%test
%  This function is taken from crater_pos.m and is adapted to show the
%  angular errors in the bearing angle and the azimuth and elvation
%  directions
%
% INPUTS
...
% Pre allocate
r_Ecrater_LOS = zeros(3, 1); % initialize
...
azimuth_error = azimuth_meas-azimuth_nom;
elevation_error = elevation_meas-elevation_nom;
